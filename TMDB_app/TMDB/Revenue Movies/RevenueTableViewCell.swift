    ...
    override func awakeFromNib() {
        ...
        AF.request(url, method: .get, parameters: params).responseJSON { (res) in
            ...
            if (res.response?.statusCode == 200 ) {
                ...
                print("Revenue Movies are ready.")
...
extension RevenueTableViewCell:UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "cell", for: indexPath) as! RevenueCollectionViewCell
